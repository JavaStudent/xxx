...
<html lang="zh-CN">
  ...
  <body>
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div>
            <ul class="nav navbar-nav" style="width:95%;">
                ...
                <li class="active"><a href="<?php echo U('Home/Index/login');?>">登陆</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div style="margin:0 auto; width:400px;">
        <form id="loginForm" class="bs-example bs-example-form" role="form" action="" method="POST" onsubmit="return false;">
            ...
            <button style="margin-top: 10px;" class="btn btn-lg btn-primary btn-block" id="submit">登陆</button>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function(){
            $("#submit").on("click",function(){
                ...
                if(checkRegister(username,password,verify))
                {
                    $("#loginForm").removeClass('redshine');
                    $.ajax({
                    ...
                    $("#loginForm").addClass('redshine');
                }
     
            });
        });

        function checkRegister(username, password, verify){
